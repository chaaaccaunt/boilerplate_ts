...
<template>
  <form class="px-5 py-4" @submit.prevent="updateUser">
    ...
    <div class="mb-5">
      <label class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-200" for="edit-user-roles">Роли</label>
      <select id="edit-user-roles" v-model="selectedRoleNames" class="min-h-24 w-full rounded-md border border-slate-300 px-3 py-2 text-sm text-slate-950 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-50 dark:focus:ring-blue-950" multiple required>
