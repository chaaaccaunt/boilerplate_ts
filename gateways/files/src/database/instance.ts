...
import { createFileModels, FileModels } from "@/models/files/FileModelRegistry"
...
export interface iModels extends FileModels { }
...
export class Database {
  ...
  constructor(config: Options) {
    ...
    this.models = createFileModels(this.sequelize)
  }
}
