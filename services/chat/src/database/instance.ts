...
import { ChatModels, createChatModels } from "@/models/chat/ChatModelRegistry"
...
export interface iModels extends ChatModels { }
...
export class Database {
  ...
  constructor(config: Options) {
    ...
    this.models = createChatModels(this.sequelize)
  }
}
