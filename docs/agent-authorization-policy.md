# Политика аутентификации и авторизации для агентов
...
`claims` являются extension data конкретного проекта.
Агент не должен предполагать фиксированную структуру `claims`, если пользователь явно ее не определил.
